...
const EditCategories = (props: Props) => {
  ...
  // Effect to handle data and state updates
  useEffect(() => {
    if (data) {
  ...
  }, [data, layoutSuccess, error, refetch]); // Refetch function added to dependency

  // Handler to update a category title
