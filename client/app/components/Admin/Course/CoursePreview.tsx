  ...
  return (
    <div className="w-[90%] m-auto py-5 mb-5">
      ...
      <div className="w-full">
        ...
        {/* course description */}
        <div className="w-full">
          <h1 className="text-[25x] font-Poppins font-[600]">Course Details</h1>
          <p className="text-[18px] mt-[20px] whitespace-pre-line w-full overflow-hidden"></p>
