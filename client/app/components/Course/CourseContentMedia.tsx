...
const CourseContentMedia = ({
  ...
  const { data: courseData, refetch: courseRefetch } =
    useGetCourseAnalyticsQuery(id, { refetchOnMountOrArgChange: true });
  const [
    addAnswerInQuestion,
    {
  ...
  const handleReviewSubmit = async () => {
    if (review.length === 0) {
      ...
      addReviewInCourse({ courseId: id, review, rating });
    }
  };
  ...
  const handleReviewReplySubmit = async () => {
    if (!replyCreationLoading) {
      if (reply === "") {
        ...
        addReplyInReview({ comment: reply, course: id, reviewId });
      }
    }
  };
  ...
  return (
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      ...
      <div className="w-full flex items-center justify-between my-3">
        ...
        >
          Next Lesson
          <AiOutlineArrowLeft className="ml-2 transform rotate-180" />
        </div>
      </div>
      ...
      {activeBar === 3 && (
        <div className="w-full">
          <>
            ...
            <br />
            <div className="w-full h-[1px」 Obg-[#ffffff3b]"></div>
            <div className="w-full">
    ...
    <>
      <div className="my-4">
        ...
        <div className="w-full flex">
          ...
          <BiMessage
            size={20}
            className="dark:text-[#ffffff83] cursor-pointer text-[#000008b8]"
          />
          <span className="pl-1 mt-[-4px] cursor-pointer text-[#000008b8]  dark:text-[#ffffff83]">
